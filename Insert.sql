...
VALUES  ( N'NV001' ,N'Nguyễn Tuấn Anh' ,25 ,N'Nam' ,  6000000 ,N'KV001')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV002' ,N'Nguyễn Văn Tính' ,22 ,N'Nam' ,  7000000 ,N'KV004')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV003' ,N'Hồ Quang Hiếu' ,30 ,N'Nam' ,  5000000 ,N'KV002')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV004' ,N'Nguyễn Tự Long' ,35 ,N'Nam' ,  7000000 ,N'KV006')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV005' ,N'Nguyễn Thị Hương' ,30 ,N'Nữ' ,  8000000 ,N'KV005')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV006' ,N'Vương Văn Thanh' ,27 ,N'Nam' ,  7000000 ,N'KV007')

INSERT dbo.NhanVien ( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV007' ,N'Nguyễn Thị Nhung' ,29 ,N'Nữ' ,  6000000 ,N'KV001')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV08' ,N'Đỗ Thị Hằng' ,32 ,N'Nữ' ,  7000000 ,N'KV005')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV009' ,N'Ngô Thị Ánh' ,45 ,N'Nữ' ,  8000000 ,N'KV003')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV010' ,N'Cao Thái Sơn' ,20 ,N'Nam' ,  5000000 ,N'KV008')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV011' ,N'Cao Tùng Anh' ,26 ,N'Nam' ,  6000000 ,N'KV006')

INSERT dbo.NhanVien ( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV12' ,N'Vương Thị Tâm' ,25 ,N'Nữ' ,  6000000 ,N'KV002')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV013' ,N'Lê Thị Trang' ,24 ,N'Nữ' ,  5000000 ,N'KV003')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV014' ,N'Nguyễn Tùng Lâm' ,29 ,N'Nam' ,  6500000 ,N'KV006')

INSERT dbo.NhanVien ( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV015' ,N'Nguyễn Thị Hà' ,23 ,N'Nữ' ,  5500000 ,N'KV004')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV016' ,N'Vương Văn Long' ,24 ,N'Nam' ,  6700000 ,N'KV001')

INSERT dbo.NhanVien ( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV017' ,N'Trần Văn Hiếu' ,25 ,N'Nam' ,  7700000 ,N'KV002')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV18' ,N'TRịnh Định Quang' ,40 ,N'Nam' ,  6000000 ,N'KV003')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV019' ,N'Nguyễn Công Phượng' ,37 ,N'Nam' ,  7000000 ,N'KV004')

INSERT dbo.NhanVien( Ma_NV ,Ten_NV ,Tuoi ,Gioi_Tinh ,Luong , Ma_Khu    )
VALUES  ( N'NV020' ,N'Nguyễn Hữu Thắng' ,46 ,N'Nam' ,  8000000 ,N'KV002')
...
INSERT dbo.KhachHang(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH001', N'Lê Như Quỳnh',20,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH002', N'Nguyễn Trọng Bằng',15,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH003', N'Phạm Thanh Vân',6,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH004', N'Phan Anh Tuấn',10,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH005', N'Dương Huyền Trang',19,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH006', N'Nguyễn Tài Đức',23,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH007', N'Nguyễn Thị Bích Ngọc',8,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH008', N'Nguyễn Hằng Nga',18,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH009', N'Cao Xuân Kiên',13,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH010', N'Trần Đức Việt',17,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH011', N'Nguyễn Bảo Ngọc	',21,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH012', N'Phạm Quang Thắng',11,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH013', N'Nguyễn Ngọc Mai',18,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH014', N'Nguyễn Việt Anh',7,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH015', N'Uông Thanh Hằng',16,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH016', N'Lê Trường Giang',21,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH017', N'Phạm Mai Trang',13,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH018', N'Nguyễn Anh Huy',25,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH019', N'Nguyễn Thị Thu Hương',9,N'Nữ')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
VALUES	(N'KH020', N'Nguyễn Hồng Sơn',11,N'Nam')
INSERT dbo.KhachHang
		(Ma_KH, Ten_KH, Tuoi, Gioi_Tinh)
...
insert PhieuMua(Ma_Phieu,Ngay_Mua,Ma_KH)
	values (N'PM014', '2018/01/09', 350000, 'KH029')
insert PhieuMua(Ma_Phieu,Ngay_Mua,Tong_Tien,Ma_KH)
	values (N'PM015', '2017/12/30', 2000000, 'KH023')
